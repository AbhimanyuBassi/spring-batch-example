...
public class SpringBatchConfig {
    ...
    public FlatFileItemReader<Customer> reader() {
        ...
        itemReader.setResource(new FileSystemResource("src/main/resources/1-AEO2011.csv"));
